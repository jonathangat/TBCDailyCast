   ...
   $.getJSON(api_url, function(data) {
        ...
        if (numOfDailyShows == 0) {
            ...
            for (let i = 0; i < numOfDailyShows; i++){
                ...
                // add button
                $('#selection_menu').append(`<a href ="#select_performance" id="btn_show_${i}" class="button1">${performance.performance_date}</a>`);
            ...
            $('#selection_menu').append(`<a href ="#" id="btn_back" class="button1">Back</a><br />`);
